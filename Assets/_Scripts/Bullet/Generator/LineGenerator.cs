...
public class LineGenerator : OneRotateGenerator
{
	[HideInInspector]
	...
	public override void FireMissile()
	{
		...
		Line.transform.rotation = Quaternion.Euler(0, 0, CurDegree += AugmentDegree * Time.deltaTime);
		Line.transform.GetChild(0).transform.tag = this.tag;
	}
}
